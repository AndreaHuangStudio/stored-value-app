...
const CACHE='sv-ledger-cache-v3-5'; // bump to refresh clients
const ASSETS=['./','./index.html','./styles.css','./app.js','./db.js','./export.js','./import.js','./importAll.js','./manifest.webmanifest'];
