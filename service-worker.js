...
const CACHE='sv-ledger-cache-v3-1-backup';
const ASSETS=['./','./index.html','./styles.css','./app.js','./db.js','./export.js','./import.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
